...
private:
  void on_status(
    autoware::component_interface_specs_universe::vehicle::DoorStatus::Message::ConstSharedPtr msg);
  ...
  Cli<autoware::component_interface_specs_universe::vehicle::DoorCommand> cli_command_;
  Cli<autoware::component_interface_specs_universe::vehicle::DoorLayout> cli_layout_;
  Sub<autoware::component_interface_specs_universe::vehicle::DoorStatus> sub_status_;
  std::optional<autoware::component_interface_specs_universe::vehicle::DoorStatus::Message> status_;
};
