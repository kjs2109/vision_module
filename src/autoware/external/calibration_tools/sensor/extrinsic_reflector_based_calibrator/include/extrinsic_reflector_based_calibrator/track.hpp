...
protected:
  Track(
    builtin_interfaces::msg::Time & t0, const autoware::kalman_filter::KalmanFilter & initial_lidar_filter,
    const autoware::kalman_filter::KalmanFilter & initial_radar_filter, double lidar_convergence_thresh,
  ...
  autoware::kalman_filter::KalmanFilter lidar_filter_, radar_filter_;
